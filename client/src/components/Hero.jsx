...
import { assets, cityList } from '../assets/assets'; // adjust the path if needed
...
const Hero = () => {
  ...
  return (
    ...
    initial={{  opacity:0}}
    animate={{opacity:1}}
    transition={{duration:0.8}} className='h-screen flex flex-col items-center 
    justify-center gap-14 bg-light text-center'>
        ...
        <motion.h1     initial={{ y:50, opacity:0}}
         ...
         className='text-4xl md:text-5xl font-semibold'>Luxury 
            cars on Rent
        </motion.h1>
        <motion.form 
        ...
        bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] '>
            ...
            md:items-center gap-10 min-md:ml-8'>
                <div className='flex flex-col items-start gap-2'>
                    ...
                    <p className='px-1 text-sm tet-gray-500'>{pickupLocation ? pickupLocation : "Please select Location"}</p>
                </div>
                <div className='flex flex-col items-start gap-2'>
